...
<div class="right col-md-10 f-r">
    <header>
        <span class="notice-body"><i class="icon ion-alert"></i>  公告：</span><span id="notice">2020东北师大秋季软师报名进行中！</span>
...
<div id="chartmain2" style="width:450px; height: 450px;float:right;display:inline-block;margin-top:19px;"></div>
    ...
    <footer class="clear:both">
    	<strong class="m-l-20">Copyright © 2020 <a href="http://thoughtcoding.csxupt.com">东北师大计算机教育</a>.</strong> All rights reserved.
    </footer>
<!-- right area end -->
</div>
