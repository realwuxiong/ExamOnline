...
<body class="row">
	...
	<div class="right col-md-10 f-r">
		<header> <span class="notice-body"><i
			class="icon ion-alert"></i> 公告：</span> <span id="notice">2020东北师大在线考试火热报名中。。。</span>
		...
		<footer> <strong class="m-l-20">Copyright © 2020 <a
			href="http://thoughtcoding.csxupt.com">东北师大计算机教育</a>.
