...
<body>
	<!--top menu-->
	<header> <img src="student/img/logo.jpg"> <strong>东北师大在线考试管理系统</strong>
	<div class="loginDiv">
	...
	<div class="section col-md-10  clearfix">
		...
		<div class="explain">
			<h2>使用须知</h2>
			<h4>1.欢迎使用东北师大考试系统，请使用报名提供的学号和密码登录</h4>
	...
	<div class="footer">
		<strong class="footer m-l-20">Copyright © 2020 <a
			href="http://thoughtcoding.csxupt.com">东北师大计算机教育</a>.All rights
			reserved.
		</strong>
	</div>
